...
using static DVLD_BusinessLayer.clsLicenseBusiness;
    ...
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private int _GetApplicationTypeID()
        {
            ...
            if (rbDamagedLicense.Checked)
                ...
                return (int)clsApplicationsBusiness.enApplicationType.ReplaceDamagedDrivingLicense;
            else
                return (int)clsApplicationsBusiness.enApplicationType.ReplaceLostDrivingLicense;
        }
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = clsApplicationTypesBusiness.Find(_GetApplicationTypeID()).Fees.ToString();
        }
        ...
        private void btnIssueReplacement_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Licensed Replaced Successfully with ID=" +
                _NewLicenseID.ToString(), "License Issued", MessageBoxButtons.OK, MessageBoxIcon.Information);
