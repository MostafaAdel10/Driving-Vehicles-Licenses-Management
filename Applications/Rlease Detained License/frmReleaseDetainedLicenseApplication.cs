...
namespace DVLD_DrivingLicenseManagement
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblApplicationFees.Text = clsApplicationTypesBusiness
                .Find((int)clsApplicationsBusiness.enApplicationType.ReleaseDetainedDrivingLicsense).Fees.ToString();
            ...
            lblCreatedByUser.Text = 
                ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainedInfo.CreatedByUserInfo.UserName;
            lblDetainDate.Text = 
                clsFormat.DateToShort(ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainedInfo.DetainDate);
            lblFineFees.Text = 
                ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainedInfo.FineFees.ToString();
            lblTotalFees.Text = 
                (Convert.ToSingle(lblApplicationFees.Text) + Convert.ToSingle(lblFineFees.Text)).ToString();
