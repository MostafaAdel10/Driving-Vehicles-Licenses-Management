...
namespace DVLD_DrivingLicenseManagement
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            int ActiveInternaionalLicenseID = clsInternationalLicenseBusiness
            ...
            if (ActiveInternaionalLicenseID != -1)
            {
                MessageBox.Show("Person already have an active international license with ID = "
                    + ActiveInternaionalLicenseID.ToString(), "Not allowed", MessageBoxButtons.OK,
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = clsApplicationTypesBusiness.
                Find((int)clsApplicationsBusiness.enApplicationType.NewInternationalLicense).Fees.ToString();
            lblCreatedByUser.Text = clsGlobal.CurrentUser.UserName;
        }

        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Are you sure you want to issue the intrnational license?",
            ...
            InternationalLicense.ApplicationStatus = clsApplicationsBusiness.enApplicationStatus.Completed;
            InternationalLicense.LastStatusDate = DateTime.Now;
            InternationalLicense.PaidFees = clsApplicationTypesBusiness.Find((int)clsApplicationsBusiness.enApplicationType.NewInternationalLicense).Fees;
            ...
            {
                MessageBox.Show("Faild to Issue International License",
        ...
        {
            frmShowInternationalLicense frm =
              new frmShowInternationalLicense(_InternationalLicenseID);
            frm.ShowDialog();
        }
