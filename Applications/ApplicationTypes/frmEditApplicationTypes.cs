...
namespace DVLD_DrivingLicenseManagement
{
    public partial class frmEditApplicationTypes : Form
    {
        ...
        private clsApplicationTypesBusiness _ApplicationType;
        public frmEditApplicationTypes(int AplicationTypeID)
        {
            InitializeComponent();
            _ApplicationTypeID = AplicationTypeID;
        }

        private void frmEditApplicationTypes_Load(object sender, EventArgs e)
        {
            lblApplicationTypeID.Text = _ApplicationTypeID.ToString();
            _ApplicationType = clsApplicationTypesBusiness.Find(_ApplicationTypeID);
