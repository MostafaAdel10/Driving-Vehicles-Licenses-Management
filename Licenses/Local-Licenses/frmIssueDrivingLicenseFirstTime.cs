    ...
    public partial class frmIssueDrivingLicenseFirstTime : Form
    {
        ...
        private void frmIssueDrivingLicenseFirstTime_Load(object sender, EventArgs e)
        {
            ...
            if (_LocalDrivingLicenseApplication == null)
            {
                ...
                MessageBox.Show("No Applicaiton with ID=" + _LocalDrivingLicenseApplicationID.ToString(),
            ...
            if (LicenseID != -1)
            {
                ...
                MessageBox.Show("Person already has License before with License ID="
                    + LicenseID.ToString(), "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
                return;
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            int LicenseID = _LocalDrivingLicenseApplication
                .IssueLicenseForTheFirtTime(txtNotes.Text.Trim(), clsGlobal.CurrentUser.UserID);
