...
namespace DVLD_DrivingLicenseManagement
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            _dtDriverLocalLicensesHistory = clsDriverBusiness.GetLicenses(_DriverID);
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            _dtDriverInternationalLicensesHistory = clsDriverBusiness.GetInternationalLicenses(_DriverID);
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if( _Driver == null )
            {
                MessageBox.Show("There is no driver with id = " + _DriverID , "Erorr",MessageBoxButtons.OK);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no Person with id = " + PersonID, "Erorr", MessageBoxButtons.OK);
                return;
            }
