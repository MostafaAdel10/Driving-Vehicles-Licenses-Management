...
namespace DVLD_BusinessLayer
{
    public class clsPeopleBusiness
    {
        ...
        private clsPeopleBusiness(int PersonID, string FirstName, string SecondName, string ThirdName,
        ...
        public static clsPeopleBusiness Find(int PersonID)
        {
            ...
            if (IsFound)
                ...
                return new clsPeopleBusiness(PersonID, FirstName, SecondName, ThirdName, LastName,
