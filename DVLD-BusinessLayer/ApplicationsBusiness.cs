...
namespace DVLD_BusinessLayer
{
    public class clsApplicationsBusiness
    {
        ...
        private clsApplicationsBusiness(int ApplicationID, int ApplicantPersonID,
...

        {
            ...
            this.ApplicationTypeInfo = clsApplicationTypesBusiness.Find(ApplicationTypeID);
            this.ApplicationStatus = ApplicationStatus;
            this.LastStatusDate = LastStatusDate;
            this.PaidFees = PaidFees;
            this.CreatedByUserID = CreatedByUserID;
            this.CreatedByUserInfo = clsUsersBusiness.FindByUserID(CreatedByUserID);
            Mode = enMode.Update;
        }
        ...
        public static clsApplicationsBusiness FindBaseApplication(int ApplicationID)
        {
            ...
            if (IsFound)
                ...
                return new clsApplicationsBusiness(ApplicationID, ApplicantPersonID,
        ...
        public static int GetActiveApplicationID(int PersonID, clsApplicationsBusiness.enApplicationType ApplicationTypeID)
        {
