...
{
    public partial class ctrlSchedualeTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                lblRetakeAppFees.Text = clsApplicationTypesBusiness
                    .Find((int)clsApplicationsBusiness.enApplicationType.RetakeTest).Fees.ToString();
            ...
            {
                lblFees.Text = clsTestTypeBusiness.Find(_TestTypeID).Fees.ToString();
            ...
            lblTotalFees.Text = (Convert.ToSingle(lblFees.Text) + 
                Convert.ToSingle(lblRetakeAppFees.Text)).ToString();
        ...
        {
            if (_Mode == enMode.AddNew && clsLocalDrivingLicenseApplicationBusiness
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            {
                //incase the mode is add new and creation mode is retake test we should create
                //a seperate application for it.
                ...
                Application.ApplicationTypeID = (int)clsApplicationsBusiness.enApplicationType.RetakeTest;
                Application.ApplicationStatus = clsApplicationsBusiness.enApplicationStatus.Completed;
                Application.LastStatusDate = DateTime.Now;
                Application.PaidFees = clsApplicationTypesBusiness.
                    Find((int)clsApplicationsBusiness.enApplicationType.RetakeTest).Fees;
        ...
        private bool _LoadTestAppointmentData()
        {
            ...
            //if (dtpTestDate.Value < currentDate)
            //{
            //    errorProvider.SetError(dtpTestDate, "You can not set an Appointment on the past ");
            //}
            //else
            //{
            //    errorProvider.SetError(dtpTestDate, null);
            //}
