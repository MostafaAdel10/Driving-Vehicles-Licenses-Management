...
namespace DVLD_DrivingLicenseManagement
{
    public partial class frmAddUpdateUser : Form
    {
        ...
        {
            _User = clsUsersBusiness.FindByUserID(_UserID);
            ...
            ctrlPersonCarddWithFilter1.LoadPersonInfo(_User.PersonID);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _User.PersonID = ctrlPersonCarddWithFilter1.PersonID;
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            if (ctrlPersonCarddWithFilter1.PersonID != -1)
            {
                ...
                if (clsUsersBusiness.isUserExistForPersonID(ctrlPersonCarddWithFilter1.PersonID))
                {
